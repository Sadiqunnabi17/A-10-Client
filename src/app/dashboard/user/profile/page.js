...
import { FiUser, FiMail, FiEdit, FiSave, FiShoppingBag, FiBookmark } from "react-icons/fi";
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-accent rounded-xl p-6">
            ...
            <p className="text-xs text-gray-400">
              Contact admin to upgrade your account to writer status and start publishing your ebooks.
            </p>
          </div>
        </div>
      </div>
